  ...
  <tbody>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>
          Databases<br/>Java EE security<br/>Remote EJB lookups<br/>Remote EJB providers
        </td>
     </tr>
  </tbody>
</table>
...
- Provides the resources necessary to deploy your application using an operator.
  ...
  <tbody>
    ...
    <tr><td>Operator resources</td><td>Deploy and manage your migrated application.</td></tr><tr>
